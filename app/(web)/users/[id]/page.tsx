...
import { Table, Chart, RatingModal, BackDrop } from "@/components";
...
const UserDetails = (props: { params: { id: string } }) => {
	...
	if (error || errorGettingUserData) throw new Error("Error fetching data");
	if (typeof userBookings === "undefined" && !isLoading)
		throw new Error("Error fetching data");
	if (typeof userData === "undefined" && !loadingUserData)
		throw new Error("Error fetching data");
	if (loadingUserData) return <LoadingSpinner />;
	// if (!userData) throw new Error("Error fetching data");

	return (
		<div className="container mx-auto px-4 md:px-4 py-10">
