...
import { RoomReview } from "@/components";
...
const RoomDetails = (props: { params: { slug: string } }) => {
	...
	const handleBookNow = async () => {
		if (!checkinDate || !checkoutDate)
			return toast.error("Please provide a checkin / checkout date");

		if (checkinDate > checkoutDate)
			return toast.error("Please choose a valide checkin period");
							...
							<div className="mb-11">
								...
								<div className="grid grid-cols-2">
									...
									<div className="flex items-center my-1 md:my-0">
										...
										<p className="ml-2 md:text-base text-xs">
											Disinfection and Sterializations
										</p>
									</div>
									<div className="flex items-center my-1 md:my-0">
										<GiSmokeBomb />
