...
const FeaturedRoom: FC<Props> = ({ featuredRoom }) => {
	return (
		<section className="flex md:flex-row flex-col px-4 py-10 items-center justify-between gap-12 container mx-auto">
			<div className="md:grid w-[43rem] gap-8 grid-cols-1">
